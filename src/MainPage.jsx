...
const MainPage = () => {
  ...
  return (
    <div className="h-screen w-screen  bg-slate-100 flex">
      <nav className="h-[99.5%] w-[16%] bg-slate-400 flex flex-col items-center gap-4 pt-14">
      ...
      <div className="ControlPannel px-2 py-2 h-full w-[84%] ">
        <div className="h-14 py-2 flex justify-between items-center border-b border-collapse mb-5">
        ...
        <div className="OptionPanel w-full h-35 bg-[#66B6D2] flex items-center justify-evenly p-4">
