...
const MainPage = () => {
  ...
  const [divtoberendered, setdivtoberendered] = useState(
    ...
    >
      ...
      <div className="ControlPannel  py-2 h-full w-[82%] ">
        ...
        <div className="hover:cursor-pointer OptionPanel w-full h-40 border-b flex items-center justify-evenly p-4">
          <div
            onClick={() =>
              setdivtoberendered(<UserTable isLighttheme={isLighttheme} />)
            }
            className=" transition duration-500 hover:scale-95  cursor-pointer h-32 w-32 bg-gradient-to-br from-pink-600 via-pink-500 to-yellow-500 rounded-xl flex flex-col items-center justify-center gap-2"
          >
            <FaRegCircleUser className="text-5xl text-white pr-1" />
            <h1 className="text-white text-xl">View Users</h1>
          </div>
          <div
            onClick={() => setdivtoberendered(<EventTable />)}
            className="transition duration-500  hover:scale-95  cursor-pointer h-32 w-32 bg-gradient-to-br from-pink-600 via-pink-500 to-yellow-500 rounded-xl flex flex-col items-center justify-center gap-2"
          >
          ...
          <div
            onClick={() => setdivtoberendered(<CategoryTable />)}
            className="transition duration-500 hover:scale-95  cursor-pointer h-32 w-32 bg-gradient-to-br from-pink-600 via-pink-500 to-yellow-500 rounded-xl flex flex-col items-center justify-center gap-2"
          >
          ...
          <div
            onClick={() => setdivtoberendered(<LocationTable />)}
            className="transition duration-500 hover:scale-95  cursor-pointer h-32 w-32 bg-gradient-to-br from-pink-600 via-pink-500 to-yellow-500 rounded-xl flex flex-col items-center justify-center gap-2"
          >
          ...
          <div
            onClick={() => setdivtoberendered(<VenueTable />)}
            className="transition duration-500 hover:scale-95  cursor-pointer h-32 w-32 bg-gradient-to-br from-pink-600 via-pink-500 to-yellow-500 rounded-xl flex flex-col items-center justify-center gap-2"
          >
            <IoLocationSharp className="text-5xl text-white pr-1" />
